...
INSERT INTO `tiendas` (`cod`, `nombre`, `tlf`)
VALUES (1, 'CENTRAL', '600100100'),
       (2, 'SUCURSAL1', '600100200'),
       (3, 'SUCURSAL2', NULL);

INSERT INTO `familias` (`cod`, `nombre`)
VALUES ('CAMARA', 'Camaras digitales'),
       ('CONSOL', 'Consolas'),
...
VALUES ('3DSNG', NULL, 'Nintendo 3DS negro', 'Consola portátil de Nintendo que permitirá disfrutar de
